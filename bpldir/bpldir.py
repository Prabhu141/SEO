...
def open_website():
            ...
            # Web Automation
                ...
                for line in csv_reader:
                    ...
                    goto = driver.find_elements("xpath", '//*[@id="ok"]')
                    goto[0].click()
                    ...
                    goto = driver.find_elements("xpath", '//*[@id="submitForm"]/table/tbody/tr/td/div/div[1]/table/tbody/tr[3]/td/center/input')
                    goto[0].click()
                    ...
                    submit = driver.find_elements("xpath", '//*[@id="submitForm"]/table/tbody/tr[12]/td/input')
                    submit[0].click()
                    print("completed")
                    driver.quit()
